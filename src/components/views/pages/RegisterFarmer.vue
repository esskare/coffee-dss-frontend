    ...
    <div class="flex-1 overflow-hidden flex flex-col">
      ...
      <div class="p-4 md:p-5 bg-custom-grey4 border-b border-gray-200">
        <div class="flex justify-between items-center">
          <h1 class="text-xl md:text-base font-bold">Register New Farmer</h1>
          <button
    ...
    <line x1="6" y1="6" x2="18" y2="18"></line>
      ...
      <div class="flex-1 overflow-y-auto bg-custom-grey3 p-4 md:p-5 md:ml-4">
        ...
        <div class="mb-8 md:mb-12">
          <!-- Step 1: ID Number Form -->
          <div v-if="currentStep === 1" class="space-y-4">
            <div>

              <label for="idNumber" class="block text-sm font-sm text-gray-700 mb-1">ID Number</label>
              <input
                id="idNumber"
...
const steps = [
  {
    ...
    title: 'ID Number',
    description: "Enter the farmer's ID Number to automatically get their details"
  },
  {
    category: 'Personal Details',
    title: 'Confirm Personal Details',
    description: "Verify the personal information retrieved from the ID"
  },
  {
    category: 'Farm',
    title: 'Farm Details',
    description: "Enter information about the farmer's agricultural operation"
  },
  {
    category: 'Payment',
    title: 'Payment Details',
    description: "Add bank account and payment information for transactions"
  }
]
  ...
  switch (currentStep.value) {
    case 1:
      if (!formData.value.idNumber.trim()) {
        errorMessage.value = 'ID Number is required.'
        return false
      }
      break
    case 2:
...
const goToNextStep = async () => {
 ...
 // Inside your goToNextStep method
if (currentStep.value < steps.length) {
  currentStep.value++
  window.scrollTo(0, 0)
} else {
  // Submit the form and redirect to /Fregistration
  console.log(formData.value)
  alert('Form submitted!')
  window.location.href = '/Fregistration';}
